...
CREATE TABLE `jobs` (
  ...
  CONSTRAINT `fk_jobs_users` FOREIGN KEY (`idusers`) REFERENCES `users` (`idusers`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-03-11 23:24:51
